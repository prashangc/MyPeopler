...
class ProductOrderReportView extends StatefulWidget {
  const ProductOrderReportView({super.key});
  @override
  State<ProductOrderReportView> createState() => _ProductOrderReportState();
}

class _ProductOrderReportState extends State<ProductOrderReportView> {
              ...
              return Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: ((context, index) {
                    if (controller.productOrderReport?[index].status !=
                        'dispatch') {
                      return SizedBox(
                        height: 95,
                        child: Card(
                          child: ListTile(
                              ...
                              Get.to(
                                () => ProductOrderReportItemView(
                                  ...
                                  clientType: controller
                                      .productOrderReport![index].clientType
                                      .toString(),
                            ...
                            trailing: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Rs. ${getGrandTotal(controller.productOrderReport![index].items)}',
  ...
  Future<void> _switchPopUpButton(String value) async {
    switch (value) {
      ...
      case own:
        date = null;
        await Get.find<SfaProductListController>()
            .getSfaOrdersReport(dispatchable: 0, type: 'own');
        type = 'own';
        setState(() {});
        break;
      case advance_filter:
